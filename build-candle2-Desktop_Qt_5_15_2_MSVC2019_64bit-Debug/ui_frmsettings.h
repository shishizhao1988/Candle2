...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 661, 2072));
        ...
        chkEnableRotaryBxis = new QCheckBox(grpConnection_2);
        chkEnableRotaryBxis->setObjectName(QString::fromUtf8("chkEnableRotaryBxis"));

        verticalLayout_6->addWidget(chkEnableRotaryBxis);
    ...
    void retranslateUi(QDialog *frmSettings)
    {
        ...
        chkEnableRotaryAxis->setText(QCoreApplication::translate("frmSettings", "Use rotary axis (A)", nullptr));
        chkEnableRotaryBxis->setText(QCoreApplication::translate("frmSettings", "Use rotary axis ( B)", nullptr));
