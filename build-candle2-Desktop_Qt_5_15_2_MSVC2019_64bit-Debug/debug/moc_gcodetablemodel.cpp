...
#include <memory>
#include "../../src/tables/gcodetablemodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GCodeTableModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GCodeTableModel_t qt_meta_stringdata_GCodeTableModel = {
    {
QT_MOC_LITERAL(0, 0, 15) // "GCodeTableModel"
...
QT_INIT_METAOBJECT const QMetaObject GCodeTableModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractTableModel::staticMetaObject>(),
    qt_meta_stringdata_GCodeTableModel.data,
    qt_meta_data_GCodeTableModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GCodeTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GCodeTableModel.stringdata0))
